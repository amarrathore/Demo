...
public class ScriptForJenkins {
	...
	try {
		...
		driver.findElement(By.xpath("//*[@id='liCity1']/a")).click();		
		driver.findElement(By.linkText("Oakland (San Francisco area)")).click();
		//driver.findElement(By.linkText("Mexico City")).click();
		//driver.findElement(By.xpath("//*[@id='MX']/div/ul[3]/li[6]/a")).click();
	} catch (Exception e) {
